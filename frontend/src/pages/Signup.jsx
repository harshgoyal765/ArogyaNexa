    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-200">
      ...
      >
          ...
          <div className="flex gap-3 mb-4">
            <button
              ...
              className={`px-4 py-2 rounded-md border ${
                role === "patient" ? "bg-[#030d46] text-white" : "bg-white text-gray-700"
              }`}
            >
              Patient
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md border ${
                role === "doctor" ? "bg-[#030d46] text-white" : "bg-white text-gray-700"
              }`}
            >
              Doctor
            </button>
        ...
        <div className="w-1/2 flex flex-col items-center justify-center bg-[#030d46] text-white">
          ...
          <p className="text-lg tracking-wide">Aryogya Nexa</p>
        </div>
      </form>
    </div>
  );
